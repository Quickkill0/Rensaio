...
import { Pause, Play, CheckCircle2, Check, FilePen, Trash2, FolderOpen, Copy } from "lucide-react";
        ...
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-8">
          ...
          <div className="flex-1 min-w-0 space-y-3 sm:space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              ...
              {canEditSeries && (
                <Button variant="outline" onClick={onRename} disabled={renamePending} className="px-0 w-9 sm:w-auto sm:px-4">
                  <FilePen className="h-4 w-4 sm:mr-2" />
