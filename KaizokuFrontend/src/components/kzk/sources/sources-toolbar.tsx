  ...
  return (
    <>
      ...
      <div className="hidden md:flex flex-wrap items-center gap-2 pb-4 border-b border-white/5">
        ...
        {/* Check All chip */}
        <button
          className={`src-chip${isCheckingAll ? ' is-on' : ''}`}
          onClick={onCheckAll}
          disabled={isCheckingAll}
          aria-label="Check health of all installed sources"
        >
          {isCheckingAll ? (
      ...
      <div className="md:hidden flex items-center gap-2 pb-3 border-b border-white/5 overflow-x-auto scrollbar-hide">
        ...
        {/* 3-dot overflow — APK install + Check All on mobile */}
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button
          ...
          <DropdownMenuContent align="end">
            ...
            >
              ...
              {isCheckingAll ? 'Checking…' : 'Check All Health'}
            </DropdownMenuItem>
            <DropdownMenuItem onSelect={onInstallFromApk} className="gap-2">
              <Upload className="h-4 w-4" />
              Install from APK…
